...
u16 CreateMonSpriteFromNationalDexNumber(u16 nationalNum, s16 x, s16 y, u16 paletteSlot)
{
    ...
    return CreateMonPicSprite_HandleDeoxys(nationalNum, SHINY_ODDS * (1 << gSaveBlock1Ptr->tx_Features_ShinyChance), GetPokedexMonPersonality(nationalNum), TRUE, x, y, paletteSlot, TAG_NONE);
}
