...
const struct SpeciesInfo gSpeciesInfo[] =
{
    ...
    [SPECIES_BLAZIKEN] = // modified
    {
        .baseHP        = 80,
        .baseAttack    = 120,
        .baseDefense   = 70,
        .baseSpeed     = 85, //+5
        .baseSpeed_old     = 85, //+5 HnS
        .baseSpAttack  = 110,
        .baseSpDefense = 70,
        .types = { TYPE_FIRE, TYPE_FIGHTING },
        .catchRate = 45,
