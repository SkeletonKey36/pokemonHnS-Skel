...
const u8 gText_MenuPokePC[] = _("POKé PC");
...
const u8 gText_MoveRelearnerLevelUpMoves[] = _("LVL UP MOVES");
const u8 gText_MoveRelearnerEggMoves[] = _("EGG MOVES");
const u8 gText_MoveRelearnerTMHMMoves[] = _("TM/HM MOVES");
const u8 gText_MoveRelearnerTutorMoves[] = _("TUTOR MOVES");
const u8 gText_MoveRelearnerBattleInfo[] = _("Battle Info");
const u8 gText_MoveRelearnerContestInfo[] = _("Contest Info");
